...
class NavigationUtils {
  ...
  static Future<Object?> push(
    ...
    try {
      ...
      Logger.error('NavigationUtils', 'push', ex.toString());
      return false;
    }
  }
  ...
  static bool pop(BuildContext context, {Object? result}) {
    try {
      ...
      Logger.error('NavigationUtils', 'pop', ex.toString());
      return false;
    }
  }
  ...
  static Future<Object?> replace(
    ...
    try {
      ...
      Logger.error('NavigationUtils', 'replace', ex.toString());
      return false;
    }
  }
  ...
  static bool clearStack(
    ...
    try {
      ...
      Logger.error('NavigationUtils', 'clearStack', ex.toString());
      return false;
    }
  }
}
